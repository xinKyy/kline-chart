...
/* eslint-disable */
// @ts-nocheck
function drawSingleUpArrow(ctx, fromX, fromY, color, bgColor) {
    const x = fromX;
    const y = fromY;
    ctx.save();
    ...
    ctx.font = "   15px ''";
    ctx.beginPath();
    ctx.moveTo(16.2463 + x, 23.2271 + y);
    ctx.bezierCurveTo(20.778 + x, 21.5122 + y, 24 + x, 17.1324 + y, 24 + x, 12 + y);
    ctx.bezierCurveTo(24 + x, 5.37258 + y, 18.6274 + x, 0 + y, 12 + x, 0 + y);
    ctx.bezierCurveTo(5.37258 + x, 0 + y, 0 + x, 5.37258 + y, 0 + x, 12 + y);
    ctx.bezierCurveTo(0 + x, 17.4569 + y, 3.64241 + x, 22.0631 + y, 8.6286 + x, 23.5199 + y);
    ctx.lineTo(11.5839 + x, 26.4752 + y);
    ctx.bezierCurveTo(11.9744 + x, 26.8658 + y, 12.6076 + x, 26.8658 + y, 12.9981 + x, 26.4752 + y);
    ctx.lineTo(16.2463 + x, 23.2271 + y);
    ctx.closePath();
    ctx.fill("evenodd");
    ctx.stroke();
    ctx.restore();
    ...
    ctx.font = "   15px ''";
    ctx.beginPath();
    ctx.moveTo(12 + x, 16.7967 + y);
    ctx.lineTo(12 + x, 7.39258 + y);
    ctx.fill();
    ctx.stroke();
    ctx.restore();
    ctx.save();
    ...
    ctx.font = "   15px ''";
    ctx.beginPath();
    ctx.moveTo(15.6004 + x, 10.7238 + y);
    ctx.lineTo(12.0004 + x, 7.19727 + y);
    ctx.lineTo(8.40039 + x, 10.7238 + y);
    ctx.fill();
    ctx.stroke();
    ctx.restore();
    ctx.restore();
}
function drawSingleDownArrow(ctx, fromX, fromY, color, bgColor) {
    const x = fromX;
    const y = fromY;
    ctx.save();
    ctx.strokeStyle = "rgba(0,0,0,0)";
    ...
    ctx.font = "   15px ''";
    ctx.beginPath();
    ctx.moveTo(8.20531 + x, 3.37993 + y);
    ctx.bezierCurveTo(3.43761 + x, 4.96791 + y, 0.00000151253 + x, 9.4663 + y, 0.00000104907 + x, 14.7676 + y);
    ctx.bezierCurveTo(4.69686e-7 + x, 21.395 + y, 5.37258 + x, 26.7676 + y, 12 + x, 26.7676 + y);
    ctx.bezierCurveTo(18.6274 + x, 26.7676 + y, 24 + x, 21.395 + y, 24 + x, 14.7676 + y);
    ctx.bezierCurveTo(24 + x, 9.4663 + y, 20.5624 + x, 4.96792 + y, 15.7947 + x, 3.37993 + y);
    ctx.lineTo(12.7071 + x, 0.292346 + y);
    ctx.bezierCurveTo(12.3166 + x, -0.098178 + y, 11.6834 + x, -0.098178 + y, 11.2929 + x, 0.292346 + y);
    ctx.lineTo(8.20531 + x, 3.37993 + y);
    ctx.closePath();
    ctx.fill("evenodd");
    ctx.stroke();
    ctx.restore();
    ...
    ctx.font = "   15px ''";
    ctx.beginPath();
    ctx.moveTo(12 + x, 9.97092 + y);
    ctx.lineTo(12 + x, 19.375 + y);
    ctx.fill();
    ctx.stroke();
    ctx.restore();
    ctx.save();
    ...
    ctx.font = "   15px ''";
    ctx.beginPath();
    ctx.moveTo(8.39961 + x, 16.0438 + y);
    ctx.lineTo(11.9996 + x, 19.5703 + y);
    ctx.lineTo(15.5996 + x, 16.0438 + y);
    ctx.fill();
    ctx.stroke();
    ctx.restore();
    ctx.restore();
}
function drawNormalArrow(up, ctx, centerX, centerY, size, item) {
    const arrowSize = shapeSize('arrowUp', size);
    const halfArrowSize = (arrowSize - 1) / 2;
    ctx.beginPath();
    if (up) {
        const _centerY = centerY - halfArrowSize * 5;
        const _centerX = centerX - 12;
        drawSingleUpArrow(ctx, _centerX, _centerY, item.color, item.bgColor);
    }
    else {
        const _centerY = centerY - halfArrowSize;
        const _centerX = centerX - 12;
        drawSingleDownArrow(ctx, _centerX, _centerY, item.color, item.bgColor);
    }
    ctx.fill();
}
...
/* eslint-disable */
// @ts-nocheck
function drawSpecialUpArrow(ctx, fromX, fromY, color, bgColor) {
    const x = fromX;
    const y = fromY;
    ctx.save();
    ctx.strokeStyle = "rgba(0,0,0,0)";
    ...
    ctx.font = "   15px ''";
    ctx.beginPath();
    ctx.moveTo(16.2463 + x, 23.2265 + y);
    ctx.bezierCurveTo(20.778 + x, 21.5116 + y, 24 + x, 17.1318 + y, 24 + x, 11.9995 + y);
    ctx.bezierCurveTo(24 + x, 5.37203 + y, 18.6274 + x, -0.000549786 + y, 12 + x, -0.000550365 + y);
    ctx.bezierCurveTo(5.37258 + x, -0.000550945 + y, -3.68906e-8 + x, 5.37203 + y, -0.00000252363 + x, 11.9994 + y);
    ctx.bezierCurveTo(-0.00000300068 + x, 17.4564 + y, 3.6424 + x, 22.0625 + y, 8.6286 + x, 23.5194 + y);
    ctx.lineTo(11.5839 + x, 26.4747 + y);
    ctx.bezierCurveTo(11.9744 + x, 26.8652 + y, 12.6076 + x, 26.8652 + y, 12.9981 + x, 26.4747 + y);
    ctx.lineTo(16.2463 + x, 23.2265 + y);
    ctx.closePath();
    ctx.fill("evenodd");
    ctx.stroke();
    ctx.restore();
    ...
    ctx.font = "   15px ''";
    ctx.beginPath();
    ctx.moveTo(6.30986 + x, 16.294 + y);
    ctx.bezierCurveTo(6.03424 + x, 16.6032 + y, 51.56015 + x, 16.6304 + y, 5.25095 + x, 16.3548 + y);
    ctx.bezierCurveTo(4.94175 + x, 16.0791 + y, 4.91453 + x, 15.6051 + y, 5.19015 + x, 15.2959 + y);
    ctx.lineTo(9.1127 + x, 10.8955 + y);
    ctx.bezierCurveTo(9.35553 + x, 10.623 + y, 9.75919 + x, 10.565 + y, 10.069 + x, 10.7578 + y);
    ctx.lineTo(12.8776 + x, 12.5067 + y);
    ctx.lineTo(15.6576 + x, 8.95574 + y);
    ctx.lineTo(13.6581 + x, 8.95574 + y);
    ctx.bezierCurveTo(13.2439 + x, 8.95574 + y, 12.9081 + x, 8.61996 + y, 12.9081 + x, 8.20574 + y);
    ctx.bezierCurveTo(12.9081 + x, 7.79153 + y, 13.2439 + x, 7.45574 + y, 13.6581 + x, 7.45574 + y);
    ctx.lineTo(17.1341 + x, 7.45574 + y);
    ctx.bezierCurveTo(17.46 + x, 7.45574 + y, 17.7486 + x, 7.66618 + y, 17.8482 + x, 7.97647 + y);
    ctx.lineTo(18.9644 + x, 11.4528 + y);
    ctx.bezierCurveTo(19.091 + x, 11.8472 + y, 18.874 + x, 12.2695 + y, 18.4796 + x, 12.3962 + y);
    ctx.bezierCurveTo(18.0852 + x, 12.5228 + y, 17.6628 + x, 12.3057 + y, 17.5362 + x, 11.9113 + y);
    ctx.lineTo(16.8709 + x, 9.83927 + y);
    ctx.lineTo(13.6435 + x, 13.9617 + y);
    ctx.bezierCurveTo(13.4073 + x, 14.2633 + y, 12.9818 + x, 14.3385 + y, 12.6565 + x, 14.136 + y);
    ctx.lineTo(9.81221 + x, 12.365 + y);
    ctx.lineTo(6.30986 + x, 16.294 + y);
    ctx.closePath();
    ctx.fill("evenodd");
    ctx.stroke();
    ctx.restore();
...
function drawSpecialDownArrow(ctx, fromX, fromY, color, bgColor) {
    const x = fromX;
    const y = fromY;
    ctx.save();
    ctx.strokeStyle = "rgba(0,0,0,0)";
    ...
    ctx.font = "   15px ''";
    ctx.beginPath();
    ctx.moveTo(7.75371 + x, 3.54106 + y);
    ctx.bezierCurveTo(3.22204 + x, 5.25593 + y, 0.00000149776 + x, 9.63575 + y, 0.00000104907 + x, 14.7681 + y);
    ctx.bezierCurveTo(4.69686e-7 + x, 21.3955 + y, 5.37258 + x, 26.7681 + y, 12 + x, 26.7681 + y);
    ctx.bezierCurveTo(18.6274 + x, 26.7681 + y, 24 + x, 21.3955 + y, 24 + x, 14.7681 + y);
    ctx.bezierCurveTo(24 + x, 9.31121 + y, 20.3576 + x, 4.70503 + y, 15.3714 + x, 3.2482 + y);
    ctx.lineTo(12.4161 + x, 0.292894 + y);
    ctx.bezierCurveTo(12.0256 + x, -0.0976299 + y, 11.3924 + x, -0.09763 + y, 11.0019 + x, 0.292894 + y);
    ctx.lineTo(7.75371 + x, 3.54106 + y);
    ctx.closePath();
    ctx.fill("evenodd");
    ctx.stroke();
    ctx.restore();
    ...
    ctx.font = "   15px ''";
    ctx.beginPath();
    ctx.moveTo(6.30986 + x, 10.4736 + y);
    ctx.bezierCurveTo(6.03424 + x, 10.1644 + y, 5.56015 + x, 10.1372 + y, 5.25095 + x, 10.4128 + y);
    ctx.bezierCurveTo(4.94175 + x, 10.6884 + y, 4.91453 + x, 11.1625 + y, 5.19015 + x, 11.4717 + y);
    ctx.lineTo(9.1127 + x, 15.8721 + y);
    ctx.bezierCurveTo(9.35553 + x, 16.1445 + y, 9.75919 + x, 16.2026 + y, 10.069 + x, 16.0097 + y);
    ctx.lineTo(12.8776 + x, 14.2609 + y);
    ctx.lineTo(15.6576 + x, 17.8118 + y);
    ctx.lineTo(13.6581 + x, 17.8118 + y);
    ctx.bezierCurveTo(13.2439 + x, 17.8118 + y, 12.9081 + x, 18.1476 + y, 12.9081 + x, 18.5618 + y);
    ctx.bezierCurveTo(12.9081 + x, 18.976 + y, 13.2439 + x, 19.3118 + y, 13.6581 + x, 19.3118 + y);
    ctx.lineTo(17.1341 + x, 19.3118 + y);
    ctx.bezierCurveTo(17.46 + x, 19.3118 + y, 17.7486 + x, 19.1014 + y, 17.8482 + x, 18.7911 + y);
    ctx.lineTo(18.9644 + x, 15.3148 + y);
    ctx.bezierCurveTo(19.091 + x, 14.9204 + y, 18.874 + x, 14.4981 + y, 18.4796 + x, 14.3714 + y);
    ctx.bezierCurveTo(18.0852 + x, 14.2448 + y, 17.6628 + x, 14.4619 + y, 17.5362 + x, 14.8562 + y);
    ctx.lineTo(16.8709 + x, 16.9283 + y);
    ctx.lineTo(13.6435 + x, 12.8059 + y);
    ctx.bezierCurveTo(13.4073 + x, 12.5042 + y, 12.9818 + x, 12.4291 + y, 12.6565 + x, 12.6316 + y);
    ctx.lineTo(9.81221 + x, 14.4026 + y);
    ctx.lineTo(6.30986 + x, 10.4736 + y);
    ctx.closePath();
    ctx.fill("evenodd");
    ctx.stroke();
    ctx.restore();
...
function drawOptionArrow(up, ctx, centerX, centerY, size, item) {
    const arrowSize = shapeSize('arrowUp', size);
    const halfArrowSize = (arrowSize - 1) / 2;
    ctx.beginPath();
    if (up) {
        const _centerY = centerY - halfArrowSize * 5;
        const _centerX = centerX - 12;
        drawSpecialUpArrow(ctx, _centerX, _centerY, item.color, item.bgColor);
    }
    else {
        const _centerY = centerY - halfArrowSize;
        const _centerX = centerX - 12;
        drawSpecialDownArrow(ctx, _centerX, _centerY, item.color, item.bgColor);
    }
    ctx.fill();
}
...
function drawShape(item, ctx) {
    ...
    switch (item._internal_shape) {
        case 'arrowNormalDown':
            drawNormalArrow(false, ctx, item._internal_x, item._internal_y, item._internal_size, item);
            return;
        case 'arrowNormalUp':
            drawNormalArrow(true, ctx, item._internal_x, item._internal_y, item._internal_size, item);
            return;
        case 'arrowOptionDown':
            drawOptionArrow(false, ctx, item._internal_x, item._internal_y, item._internal_size, item);
            return;
        case 'arrowOptionUp':
            drawOptionArrow(true, ctx, item._internal_x, item._internal_y, item._internal_size, item);
            return;
        case 'arrowDown':
...
class SeriesMarkersPaneView {
    ...
    _internal__makeValid() {
        ...
        if (this._private__dataInvalidated) {
            this._private__data._internal_items = seriesMarkers.map((marker) => (Object.assign(Object.assign({}, marker), { _internal_time: marker.time, _internal_x: 0, _internal_y: 0, _internal_size: 0, _internal_shape: marker.shape, _internal_color: marker.color, _internal_internalId: marker._internal_internalId, _internal_externalId: marker.id, _internal_text: undefined })));
...
class Series extends PriceDataSource {
    ...
    _private__recalculateMarkers() {
        ...
        this._private__indexedMarkers = this._private__markers.map((marker, index) => {
            ...
            return Object.assign(Object.assign({}, marker), { time: seriesDataIndex, position: marker.position, shape: marker.shape, color: marker.color, id: marker.id, _internal_internalId: index, text: marker.text, size: marker.size, originalTime: marker.originalTime });
        });
    }
 ...
 */
function version() {
    return "0.0.11-dev+202310111213";
}
