// 通用网关地址
var getwayBaseUrl = 'http://gateway:8080';
// nc bff
var uatServerBaseUrl = 'http://bff-330056:4100/api/forward/';
// 根据 bid 拼接 bff 地址
var getBaseServerUrl = function getBaseServerUrl(bid) {
  return "http://bff-".concat(bid, ":4100/api/forward/");
};
// 通用 bff 命名空间地址
var commonServerBaseUrl = 'http://bff:4100/api/forward/';
// s3 与 oss 通用配置
var s3AndOssDefaultConfig = {
  // s3 匹配图片域名
...
// 默认配置
var s3CommonConfig = Object.assign(Object.assign(Object.assign(Object.assign({}, s3AndOssDefaultConfig), s3ProdConfig), s3StagingConfig), s3DevConfig);
// uat 预发布环境 s3 通用配置
var s3UatConfig = Object.assign(Object.assign(Object.assign(Object.assign({}, s3AndOssDefaultConfig), s3StagingConfig), s3DevConfig), {
  originProdS3Domain: 'https://ab-uat-s3-saas-515.s3.ap-southeast-1.amazonaws.com',
  fastProdS3Domain: 'https://ab-uat-s3-saas-515.s3-accelerate.amazonaws.com'
});
export { commonServerBaseUrl, getBaseServerUrl, getwayBaseUrl, s3AndOssDefaultConfig, s3CommonConfig, s3DevConfig, s3ProdConfig, s3StagingConfig, s3UatConfig, uatServerBaseUrl };
